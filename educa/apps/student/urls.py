...
urlpatterns = [
    ...
    path('course/<int:course_id>/lesson/<int:lesson_id>/', views_course.StudentCourseView.as_view(), name='view'),
    path('course/select_lesson/', views_lesson.SelectLessonView.as_view(), name='select_video'),
